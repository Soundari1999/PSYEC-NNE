...
world_protein = world_food_facts[world_food_facts.calorific values_100g.notnull()]

def return_calorific values(country):
    return world_calorific values[world_calorific values.countries == country][['product_name','calorific values_100g']]
...
# top_cn_calorific value_food is what we want :
